 ...
 * =============================================================================
 * 
 * Documentation page for tile event participants.
 * Loads markdown content from /docs/tile-events-guide.md
 * 
 * Access Control:
 * - Requires view_events_guide permission
 * 
 * @module TileEventsGuide
 */
...
export default function TileEventsGuide() {
  ...
  // Check permission
  const canAccess = hasPermission('view_events_guide');
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-2xl font-bold text-white mb-1">
            <span className="text-yume-accent">📖</span> Tile Events Guide
          </h1>
          <p className="text-gray-400">Learn how to participate in tile events</p>
        </div>
        <Link 
          to="/events"
